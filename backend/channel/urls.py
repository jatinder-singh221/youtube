...
from .views import channel_creater_view, create_channel, admin_channel, channel_videos, channel_playlist, get_all, channel_about
...
urlpatterns = [
    ...
    path('about/<int:pk>/', channel_about.as_view()),
