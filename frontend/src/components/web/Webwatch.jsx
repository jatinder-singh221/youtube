...
export default function Webwatch() {
    ...
    return (
        <Container>
            <Player src={details.video} poster={details.video_thumb_nail} controls controlsList='nodownload'></Player>
            <Make>
            ...
            <Over>
                ...
                <Channellink to={`/channel/${details?.channel?.id}`} >{details?.channel?.channel_name}</Channellink>
            </Over>
